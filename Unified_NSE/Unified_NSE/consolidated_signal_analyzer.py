    ...
    def _calculate_weighted_signal(self, indicators: Dict) -> Dict:
        ...
        try:
            ...
            try:
                ...
                if abs(weighted_score) < 0.12 and bb_bw <= 8.0 and (abs(macd_hist) < 0.005 or 
                    (weighted_score > 0 and macd_slope <= 0) or (weighted_score < 0 and macd_slope >= 0)):
                    old = weighted_score
                    collapse = 0.35 if exp_flag else 0.2
