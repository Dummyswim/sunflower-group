...
class EnhancedWebSocketHandler:
    ...
    def __init__(self, config):
        ...
        logger.info(f"Configuration: SecurityId={config.sensex_security_id}, "
    ...
    async def subscribe(self):
        """Subscribe to sensex market data feed - request Quote packets for volume."""
        logger.info("Subscribing to sensex market data")
        ...
        try:
            ...
            subscription = {
                ...
                "InstrumentList": [{
                    ...
                    "SecurityId": str(self.config.sensex_security_id)  # int, not str str(self.config.sensex_security_id)
                }]
            }  
    ...
    def _parse_ticker_packet(self, data: bytes) -> Optional[Dict]:
        ...
        try:
            ...
            if security_id != self.config.sensex_security_id:
                return None
    ...
    async def _create_candle(self, timestamp: datetime, ticks: List[Dict]):
        ...
        try:
            ...
            # BSE market hours: 09:15–15:30 IST 
